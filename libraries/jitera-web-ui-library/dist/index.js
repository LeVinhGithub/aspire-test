...
`,
  ...
  ar = a.default.forwardRef((c, d) => {
    let {
      ...
      { classNames: r } = be({ className: h, responsiveVisibility: f }),
      s = g.useMemo(() => (o && b ? b.find((a) => a.value === o) : null), [o, b]);
    return aP.jsx(ba.default, {
      className: r,
      components: q,
      menuIsOpen: !e && (null == a ? void 0 : a.menuIsOpen),
      styles: p,
      options: b,
      defaultValue: s,
      ...a,
