      ...
      # first loop
        ...
        if params[:email].present? && params[:password].present?
          case params[:scope]
            ...
            when 'applicants'
              resource = Applicant.authenticate?(params[:email], params[:password])
          
            when 'company_users'
              resource = CompanyUser.authenticate?(params[:email], params[:password])
        ...
        if params[:phone_number].present? && params[:otp_code].present?
          case params[:scope]
             ...
             when 'applicants'
              resource = Applicant.verify_otp?(params[:phone_number], params[:otp_code])
            end
          
             when 'company_users'
              resource = CompanyUser.verify_otp?(params[:phone_number], params[:otp_code])
            end
