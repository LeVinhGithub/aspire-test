...
variable "database_name" {
  ...
  default     = "harry_testing_9jun_issues_production"
}
...
variable "domain" {
  description = "Domain"
  default     = "harry-testing-9jun-issues-production.project.jitera.app"
}
...
variable "bucket_name" {
  default = "harry-testing-9jun-issues-production-storage"
}
