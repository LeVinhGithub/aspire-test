...
variable "database_name" {
  ...
  default     = "harry_preprod1_4apr_test_ror_codegen_production"
}
...
variable "domain" {
  description = "Domain"
  default     = "harry-preprod1-4apr-test-ror-codegen-production.project.jitera.app"
}
...
variable "bucket_name" {
  default = "harry-preprod1-4apr-test-ror-codegen-production-storage"
}
