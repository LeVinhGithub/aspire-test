...
variable "database_name" {
  ...
  default     = "harry_testing_9jun_issues_staging"
}
...
variable "domain" {
  description = "Domain"
  default     = "harry-testing-9jun-issues-staging.project.jitera.app"
}
...
variable "bucket_name" {
  default = "harry-testing-9jun-issues-staging-storage"
}
