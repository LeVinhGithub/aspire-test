...
variable "database_name" {
  ...
  default     = "harry_preprod1_4apr_test_ror_codegen_staging"
}
...
variable "domain" {
  description = "Domain"
  default     = "harry-preprod1-4apr-test-ror-codegen-staging.project.jitera.app"
}
...
variable "bucket_name" {
  default = "harry-preprod1-4apr-test-ror-codegen-staging-storage"
}
