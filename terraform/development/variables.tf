...
variable "database_name" {
  ...
  default     = "harry_pro1_10apr_development"
}
...
variable "domain" {
  description = "Domain"
  default     = "harry-pro1-10apr-development.project.jitera.app"
}
...
variable "bucket_name" {
  default = "harry-pro1-10apr-development-storage"
}
