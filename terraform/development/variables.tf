...
variable "name" {
  ...
  default     = "harry_testing_9jun_issues"
}
...
variable "database_name" {
  ...
  default     = "harry_testing_9jun_issues_development"
}
...
variable "domain" {
  description = "Domain"
  default     = "harry-testing-9jun-issues-development.project.jitera.app"
}
...
variable "bucket_name" {
  default = "harry-testing-9jun-issues-development-storage"
}
