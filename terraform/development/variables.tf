...
variable "database_name" {
  ...
  default     = "harry_pro1_10jan_development"
}
...
variable "domain" {
  description = "Domain"
  default     = "harry-pro1-10jan-development.project.jitera.app"
}
...
variable "bucket_name" {
  default = "harry-pro1-10jan-development-storage"
}
