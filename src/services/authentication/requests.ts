        ...
        export const resetPasswordVerify = (body: ResetPasswordVerifyRequestBody): Promise<SuccessResponse> => {
          ...
          return serviceFetch(
            ...
            model
                                  ...
                                  export type ApplicantsRegistration = {
            table: string;
            applicant: {
        password: string;
...
email: string;
                  ...
                  export type CompanyUsersRegistration = {
            table: string;
            company_user: {
        password: string;
password_confirmation: string;
...
phone_number: string;
                ...
                export type EmailProviderSignupBodyRequest = ApplicantsRegistration | CompanyUsersRegistration;
