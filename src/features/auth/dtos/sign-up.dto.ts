...
export class AuthRegistrationTestingRequest {
...
export class AuthRegistrationTestingRequestDto {
  
  @ObjectField(AuthRegistrationTestingRequest )
  testing: AuthRegistrationTestingRequest;
