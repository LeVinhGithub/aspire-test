...
import { StringFieldOptional, DateFieldOptional, NumberFieldOptional, EnumFieldOptional, BooleanFieldOptional, ObjectFieldOptional } from "src/decorators/field.decorator";
...
export class FilterApplicantRequest {
...
export class FilterApplicantRequestDTO {
  @ObjectFieldOptional(FilterApplicantRequest)
  applicants?: FilterApplicantRequest;
@NumberFieldOptional({ int: true})
...
export class ApplicantLanguageFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
...
export class ApplicantSchoolFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
...
export class ApplicantIndustryFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
industry_id: number;
...
export class MessageFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
applicant_id: number;
...
export class JobApplicationFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
applicant_id: number;
...
export class JobOpeningFavoriteFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
job_opening_id: number;
...
export class JobExperienceFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_name: string;
...
export class ApplicantRestrictionApplicantRestrictionFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
full_name: string;
...
export class RestrictionApplicantRestrictionFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_id: number;
applicant_id: number;
applicant: ApplicantRestrictionApplicantRestrictionFilterApplicantResponse;

}
export class ApplicantRestrictionFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
full_name: string;
...
email: string;
gender: `${ApplicantGenderEnum}`;
restrictions: RestrictionApplicantRestrictionFilterApplicantResponse[];

}
export class RestrictionFilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_id: number;
applicant_id: number;
applicant: ApplicantRestrictionFilterApplicantResponse;
reason: `${RestrictionReasonEnum}`;

}
export class TargetListFilterApplicantResponse {
  target_list_id: number;

}
export class FilterApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
full_name: string;
...
phone_number: string;
birthdate: Date;
applicant_languages: ApplicantLanguageFilterApplicantResponse[];
address: string;
income_range_id: number;
availability: `${ApplicantAvailabilityEnum}`;
applicant_schools: ApplicantSchoolFilterApplicantResponse[];
resume_file: StorageFile;
description: string;
management_experience_id: number;
applicant_industries: ApplicantIndustryFilterApplicantResponse[];
messages: MessageFilterApplicantResponse[];
location_id: number;
job_applications: JobApplicationFilterApplicantResponse[];
job_opening_favorites: JobOpeningFavoriteFilterApplicantResponse[];
email: string;
gender: `${ApplicantGenderEnum}`;
job_experiences: JobExperienceFilterApplicantResponse[];
restrictions: RestrictionFilterApplicantResponse[];
target_lists: TargetListFilterApplicantResponse[];

}


export class FilterApplicantResponseDTO {
  applicants: FilterApplicantResponse[];
    total_pages?: number;
    total_count: number;
