...
import { StringFieldOptional, DateFieldOptional, NumberFieldOptional, NumberField, EnumFieldOptional, FileFieldOptional, StringField, BooleanFieldOptional, ObjectField } from "src/decorators/field.decorator";
...
export class CreateApplicantRequestDTO {
  @ObjectField(CreateApplicantRequest)
  applicants: CreateApplicantRequest;
@ObjectField(CreateRestrictionRequest)
  restrictions: CreateRestrictionRequest;

}
export class ApplicantLanguageCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
...
export class ApplicantSchoolCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
...
export class ApplicantIndustryCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
industry_id: number;
...
export class MessageCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
applicant_id: number;
...
export class JobApplicationCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
applicant_id: number;
...
export class JobOpeningFavoriteCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
job_opening_id: number;
...
export class JobExperienceCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_name: string;
...
export class ApplicantRestrictionApplicantRestrictionCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
full_name: string;
...
export class RestrictionApplicantRestrictionCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_id: number;
applicant_id: number;
applicant: ApplicantRestrictionApplicantRestrictionCreateApplicantResponse;

}
export class ApplicantRestrictionCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
full_name: string;
...
email: string;
gender: `${ApplicantGenderEnum}`;
restrictions: RestrictionApplicantRestrictionCreateApplicantResponse[];

}
export class RestrictionCreateApplicantResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_id: number;
applicant_id: number;
applicant: ApplicantRestrictionCreateApplicantResponse;
...
phone_number: string;
birthdate: Date;
applicant_languages: ApplicantLanguageCreateApplicantResponse[];
address: string;
income_range_id: number;
availability: `${ApplicantAvailabilityEnum}`;
applicant_schools: ApplicantSchoolCreateApplicantResponse[];
resume_file: StorageFile;
description: string;
management_experience_id: number;
applicant_industries: ApplicantIndustryCreateApplicantResponse[];
messages: MessageCreateApplicantResponse[];
location_id: number;
job_applications: JobApplicationCreateApplicantResponse[];
job_opening_favorites: JobOpeningFavoriteCreateApplicantResponse[];
email: string;
gender: `${ApplicantGenderEnum}`;
job_experiences: JobExperienceCreateApplicantResponse[];
restrictions: RestrictionCreateApplicantResponse[];
...
export class CreateApplicantResponseDTO {
