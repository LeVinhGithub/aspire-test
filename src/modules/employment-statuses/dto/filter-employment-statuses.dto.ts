...
export class FilterEmploymentStatusRequest {
  @StringFieldOptional({ maxLength: 255, minLength: 0})
  name?: string;

}
export class FilterEmploymentStatusRequestDTO {
  @ObjectFieldOptional(FilterEmploymentStatusRequest)
  employment_statuses?: FilterEmploymentStatusRequest;
...
export class JobApplicationJobOpeningFilterEmploymentStatusResponse {
  id: number;
created_at: Date;
updated_at: Date;
applicant_id: number;
...
export class JobOpeningFavoriteJobOpeningFilterEmploymentStatusResponse {
  id: number;
created_at: Date;
updated_at: Date;
job_opening_id: number;
...
export class JobOpeningValuedCompetencyJobOpeningFilterEmploymentStatusResponse {
  id: number;
created_at: Date;
updated_at: Date;
job_opening_id: number;
...
export class JobOpeningFilterEmploymentStatusResponse {
  id: number;
created_at: Date;
updated_at: Date;
deployment: string;
...
transfers: boolean;
job_applications: JobApplicationJobOpeningFilterEmploymentStatusResponse[];
job_opening_favorites: JobOpeningFavoriteJobOpeningFilterEmploymentStatusResponse[];
job_opening_valued_competencies: JobOpeningValuedCompetencyJobOpeningFilterEmploymentStatusResponse[];
slug: string;
image: StorageFile;
...
export class FilterEmploymentStatusResponse {
  id: number;
created_at: Date;
updated_at: Date;
job_openings: JobOpeningFilterEmploymentStatusResponse[];
name: string;

}


export class FilterEmploymentStatusResponseDTO {
  employment_statuses: FilterEmploymentStatusResponse[];
    total_pages?: number;
    total_count: number;
  ...
  constructor(
    ...
    total_count: number,
    total_pages?: number  ) {
    this.employment_statuses = employment_statuses.map((employment_status) => ({
          ...employment_status,
          id: employment_status?.id,
created_at: employment_status?.created_at,
updated_at: employment_status?.updated_at,
job_openings: employment_status?.job_openings?.map((job_opening) => ({
            ...job_opening,
            id: job_opening?.id,
