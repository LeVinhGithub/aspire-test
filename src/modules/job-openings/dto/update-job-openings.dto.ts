...
import { NumberField, StringFieldOptional, NumberFieldOptional, BooleanFieldOptional, DateFieldOptional, FileFieldOptional, EnumFieldOptional, ObjectFieldOptional } from "src/decorators/field.decorator";
import { FileSystemStoredFile } from "nestjs-form-data";
import { StatusEnum as JobApplicationStatusEnum } from "entities/job_applications";
import { StorageFile } from "entities/storage_files";

export class UpdateJobOpeningParamsDTO {
  @NumberField({ int: true})
  id: number;

}
export class UpdateJobOpeningRequest {
...
export class UpdateJobOpeningRequestDTO {
  @ObjectFieldOptional(UpdateJobOpeningRequest)
  job_openings?: UpdateJobOpeningRequest;

}
export class JobApplicationUpdateJobOpeningResponse {
  id: number;
created_at: Date;
updated_at: Date;
applicant_id: number;
...
export class JobOpeningFavoriteUpdateJobOpeningResponse {
  id: number;
created_at: Date;
updated_at: Date;
job_opening_id: number;
...
export class JobOpeningValuedCompetencyUpdateJobOpeningResponse {
  id: number;
created_at: Date;
updated_at: Date;
job_opening_id: number;
...
export class JobTitleUpdateJobOpeningResponse {
  id: number;
created_at: Date;
updated_at: Date;
name: string;
...
export class UpdateJobOpeningResponse {
  id: number;
created_at: Date;
updated_at: Date;
deployment: string;
...
job_title_id: number;
job_opening_id: number;
job_applications: JobApplicationUpdateJobOpeningResponse[];
job_opening_favorites: JobOpeningFavoriteUpdateJobOpeningResponse[];
job_opening_valued_competencies: JobOpeningValuedCompetencyUpdateJobOpeningResponse[];
...
status: `${JobOpeningStatusEnum}`;
pv: number;
job_title: JobTitleUpdateJobOpeningResponse;
...
export class UpdateJobOpeningResponseDTO {
  
  job_opening: UpdateJobOpeningResponse
    error_object: Object;
