...
export class UpdateRestrictionParamsDTO {
...
export class UpdateRestrictionRequestDTO {
  @ObjectFieldOptional(UpdateRestrictionRequest)
  restrictions?: UpdateRestrictionRequest;

}
export class CompanyUpdateRestrictionResponse {
  id: number;
created_at: Date;
updated_at: Date;
name: string;
...
export class RestrictionApplicantRestrictionApplicantUpdateRestrictionResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_id: number;
...
export class ApplicantRestrictionApplicantUpdateRestrictionResponse {
  id: number;
created_at: Date;
updated_at: Date;
full_name: string;
...
restrictions: RestrictionApplicantRestrictionApplicantUpdateRestrictionResponse[];

}
export class RestrictionApplicantUpdateRestrictionResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_id: number;
applicant_id: number;
applicant: ApplicantRestrictionApplicantUpdateRestrictionResponse;

}
export class ApplicantUpdateRestrictionResponse {
  id: number;
created_at: Date;
updated_at: Date;
full_name: string;
...
email: string;
gender: `${ApplicantGenderEnum}`;
restrictions: RestrictionApplicantUpdateRestrictionResponse[];

}
export class UpdateRestrictionResponse {
  id: number;
created_at: Date;
updated_at: Date;
company_id: number;
company: CompanyUpdateRestrictionResponse;
applicant_id: number;
applicant: ApplicantUpdateRestrictionResponse;
reason: `${RestrictionReasonEnum}`;
...
export class UpdateRestrictionResponseDTO {
  
  restriction: UpdateRestrictionResponse
    error_object: Object;
