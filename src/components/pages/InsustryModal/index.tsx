...
type InsustryModalProps = DefaultPageProps & {
  className?: string;
  }

function InsustryModal (props: InsustryModalProps): JSX.Element {
  
  
  
  
  return (<div className={styles.page_container} ><HeaderNormal className={styles.header_normal_1} text={{}} />
<div className={styles.frame_42731890847} ><div className={styles.frame_42731889146} ><Property1DefaultRequiredFalseQuestionFalseFillFalse className={styles.text_field_3} />
<Property1DefaultRequiredFalseQuestionFalseFillFalse className={styles.text_field_3} />
<Property1DefaultRequiredFalseQuestionFalseFillFalse className={styles.text_field_3} />
<Property1DefaultRequiredFalseQuestionFalseFillFalse className={styles.text_field_3} />
<Property1DefaultRequiredFalseQuestionFalseFillFalse className={styles.text_field_3} />
<div className={styles.text_field_46} ><TextFieldTitle className={styles.text_field_ui_4} />
<div className={styles.frame_42731893914} ><Text textType='Text' className={styles.text_6} >{'▼ 会社の特色'}</Text>
<div className={styles.assets_8} ><Property1On className={styles.ic_line_checkcircle_7} />
...
<div className={styles.frame_42731885647} ><ButtonActive className={styles.btn_47} /></div></div>
...
<IcLinedelete className={styles.ic_linedelete_51} /></div>
<div className={styles.frame_42731895652} ><Property1Close className={styles.togglebtn_52} />
<Property1Close className={styles.togglebtn_52} />
<Property1Close className={styles.togglebtn_52} />
<Property1Close className={styles.togglebtn_52} />
<Property1Close className={styles.togglebtn_52} />
<Property1Close className={styles.togglebtn_52} />
...
<Property1Close className={styles.togglebtn_52} />
<Property1Close className={styles.togglebtn_52} />
<Property1Close className={styles.togglebtn_52} /></div>
<SizeLgStateDefaulticonNone className={styles.btn_52} children={{}} /></div></div></div>);
}

export default InsustryModal;
