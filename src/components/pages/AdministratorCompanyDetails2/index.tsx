...
type AdministratorCompanyDetails2Props = DefaultPageProps & {
  className?: string;
  }

function AdministratorCompanyDetails2 (props: AdministratorCompanyDetails2Props): JSX.Element {
  
  
  
  
  return (<div className={styles.page_container} ><HeaderInner className={styles.header_inner_1} ></HeaderInner>
...
export default AdministratorCompanyDetails2;
