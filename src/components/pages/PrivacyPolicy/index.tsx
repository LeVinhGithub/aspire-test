...
type PrivacyPolicyProps = DefaultPageProps & {
  className?: string;
  }

function PrivacyPolicy (props: PrivacyPolicyProps): JSX.Element {
  
  
  
  
  return (<div className={styles.container} ><div className={styles.inner_container_1667203870119} ><HeaderNormal className={styles.header_normal_3} text={'プライバシーポリシー'} />
