...
type CorporateRecCandidatesView4Props = DefaultPageProps & {
  className?: string;
  }

function CorporateRecCandidatesView4 (props: CorporateRecCandidatesView4Props): JSX.Element {
  
  
  
  
  return (<div className={styles.container} ><div className={styles.inner_container_1667978487185} ><div className={styles.frame_42731901463} ><Switcheditmode className={styles.switcheditmode_2} />
<div className={styles.frame_42731887963} ><div className={styles.frame_4273188787} ><div className={styles.frame_4273188807} ><Header className={styles.header_5} />
<div className={styles.search_7} ><IcLinesearch className={styles.ic_linesearch_6} />
<Text textType='Text' className={styles.text_7} >{'タイトル・リスト名で検索'}</Text></div></div>
...
<HeaderDefault className={styles.header_default_63} /></div></div>);
}

export default CorporateRecCandidatesView4;
