...
json.occupation_types @occupation_types do |occupation_type|
  json.id occupation_type.id

  json.created_at occupation_type.created_at

  json.updated_at occupation_type.updated_at

  json.job_openings occupation_type.job_openings do |job_openings|
  ...
  json.occupation_type_id occupation_type.occupation_type_id

  json.name occupation_type.name
end
