...
json.employment_statuses @employment_statuses do |employment_status|
  json.id employment_status.id

  json.created_at employment_status.created_at

  json.updated_at employment_status.updated_at

  json.job_openings employment_status.job_openings do |job_openings|
  ...
  json.name employment_status.name
end
