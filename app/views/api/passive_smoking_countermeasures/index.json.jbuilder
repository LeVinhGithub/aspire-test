...
json.passive_smoking_countermeasures @passive_smoking_countermeasures do |passive_smoking_countermeasure|
  json.id passive_smoking_countermeasure.id

  json.created_at passive_smoking_countermeasure.created_at

  json.updated_at passive_smoking_countermeasure.updated_at

  json.job_openings passive_smoking_countermeasure.job_openings do |job_openings|
  ...
  json.passive_smoking_countermeasure_id passive_smoking_countermeasure.passive_smoking_countermeasure_id

  json.name passive_smoking_countermeasure.name
end
