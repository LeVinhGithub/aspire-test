...
class CreateCompanyRequest extends FormRequest
{
    ...
    {
        return [
            'companies.name' => 'required|string|max:255|min:0|unique:companies,name',
            'companies.logo' => 'file|max:5120|mimes:bmp,gif,jpeg,jpg,jpe,png,tiff,tif',
            ...
            'companies.slug' => 'required|string|max:255|min:0|unique:companies,slug',
