...
class CreateCompanyUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'company_users.email' => 'required|string|email|max:255|min:0|unique:company_users,email',
            'company_users.role' => 'required|in:admin,standard',
            'company_users.phone_number' => 'required|string|max:255|min:0|unique:company_users,phone_number',
        ];
    }
