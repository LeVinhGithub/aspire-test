...
namespace App\Http\Resources\PassiveSmokingCountermeasure;

use App\Http\Resources\BaseJsonCollection;

class FilterPassiveSmokingCountermeasureCollection extends BaseJsonCollection
{
    /**
     ...
     * @var string|null
     */
    public static $wrap = 'passive_smoking_countermeasures';
