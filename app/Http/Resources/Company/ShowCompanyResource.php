...
class ShowCompanyResource extends BaseJsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        return  [
            ...
            'scout_templates' => $this->scoutTemplates->map(function ($scoutTemplate) {
                return [
                    'id' => $scoutTemplate->id,
                    'created_at' => $scoutTemplate->created_at,
                    'updated_at' => $scoutTemplate->updated_at,
                    'title' => $scoutTemplate->title,
                    'template_text' => $scoutTemplate->template_text,
                    'company_id' => $scoutTemplate->company_id,

                ];
            }),
            'target_lists' => $this->targetLists->map(function ($targetList) {
                return [
                    'id' => $targetList->id,
                    'created_at' => $targetList->created_at,
                    'updated_at' => $targetList->updated_at,
                    'title' => $targetList->title,
                    'company_id' => $targetList->company_id,
                    'applicants' => $targetList->targetListApplicants->map(function ($targetListApplicant) {
                        return [
                            'applicant_id' => $targetListApplicant->applicant_id,
            ...
            'recruitment_notes' => $this->recruitmentNotes->map(function ($recruitmentNote) {
                return [
                    'id' => $recruitmentNote->id,
                    'created_at' => $recruitmentNote->created_at,
                    'updated_at' => $recruitmentNote->updated_at,
                    'applicant_id' => $recruitmentNote->applicant_id,
                    'note' => $recruitmentNote->note,
