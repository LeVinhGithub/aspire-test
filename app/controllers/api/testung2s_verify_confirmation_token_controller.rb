module Api
  class Testung2sVerifyConfirmationTokenController < Api::BaseController
    ...
    def create
      resource = Testung2.find_by(confirmation_token: params[:confirmation_token])
      ...
      if (resource.confirmation_sent_at + Testung2.confirm_within) < Time.now.utc
