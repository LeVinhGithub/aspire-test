class Api::ApplicantsVerifyConfirmationTokenController < Api::BaseController
  def create
    ...
    resource = Applicant.find_by(confirmation_token: params.dig(:confirmation_token))
    ...
    if (resource.confirmation_sent_at + Applicant.confirm_within) < Time.now.utc
