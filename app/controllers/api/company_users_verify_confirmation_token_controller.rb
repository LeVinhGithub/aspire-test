class Api::CompanyUsersVerifyConfirmationTokenController < Api::BaseController
  def create
    ...
    resource = CompanyUser.find_by(confirmation_token: params.dig(:confirmation_token))
    ...
    if (resource.confirmation_sent_at + CompanyUser.confirm_within) < Time.now.utc
